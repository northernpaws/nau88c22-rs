...
pub enum Register {
    ...
    NotchFilter2 = NOTCH_FILTER_2,
    NotchFilter3 = NOTCH_FILTER_3,
    ...
    // PCM Time Slot and ADCOUT Impedance Option Control
    LeftTimeSlot = LEFT_TIME_SLOT,
    Misc = MISC,
    RightTimeSlot = RIGHT_TIME_SLOT,
...
impl HasAddress for PowerManagement1 {
    fn address(&self) -> Register {
...
impl HasAddress for PowerManagement2 {
    fn address(&self) -> Register {
...
impl HasAddress for PowerManagement3 {
    fn address(&self) -> Register {
...
impl HasAddress for AudioInterface {
    fn address(&self) -> Register {
...
impl HasAddress for Companding {
    fn address(&self) -> Register {
        Register::Companding
    }
}
...
impl HasAddress for ClockControl1 {
    fn address(&self) -> Register {
...
impl HasAddress for ClockControl2 {
    fn address(&self) -> Register {
...
impl HasAddress for JackDetect1 {
    fn address(&self) -> Register {
...
impl HasAddress for JackDetect2 {
    fn address(&self) -> Register {
...
impl HasAddress for NotchFilter1 {
    fn address(&self) -> Register {
...
impl HasAddress for NotchFilter2 {
    fn address(&self) -> Register {
...
impl HasAddress for NotchFilter3 {
    fn address(&self) -> Register {
...
impl HasAddress for NotchFilter4 {
    fn address(&self) -> Register {
...
bitfield! {
    pub struct ALCControl2(pub u16): FromStorage, IntoStorage {
...
bitfield! {
    pub struct ALCControl3(pub u16): FromStorage, IntoStorage {
...
impl HasAddress for RightSpeakerSubmixer {
    fn address(&self) -> Register {
        Register::RightSpeakerSubmixer
    }
}
...
impl HasAddress for InputControl {
    fn address(&self) -> Register {
...
impl HasAddress for OutputControl {
    fn address(&self) -> Register {
...
impl HasAddress for RightMixer {
    fn address(&self) -> Register {
        Register::RightMixer
    }
}
...
impl HasAddress for PowerManagement4 {
    fn address(&self) -> Register {
        Register::PowerManagement4
    }
}
...
impl HasAddress for LeftTimeSlot {
    fn address(&self) -> Register {
...
impl HasAddress for RightTimeSlot {
    fn address(&self) -> Register {
...
impl HasAddress for DeviceRevisionNumber {
    fn address(&self) -> Register {
        Register::DeviceRevisionNumber
    }
}
...
impl HasAddress for MiscControls {
    fn address(&self) -> Register {
...
impl HasAddress for InputTieOffDirectManualControl {
    fn address(&self) -> Register {
        Register::InputTieOffDirectManualControl
    }
}
...
impl HasAddress for AutomuteControlAndStatusReadout {
    fn address(&self) -> Register {
        Register::AutomuteControlAndStatusReadout
    }
}
...
impl HasAddress for OutputTieOffDirectManualControls {
    fn address(&self) -> Register {
        Register::OutputTieOffDirectManualControls
    }
}
